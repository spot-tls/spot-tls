...
root = r'C:\Users\basti\Google Drive\marketing\SPOT cabau lesavre\Mise en route\APP\spot-app-v2'
...
out_path = os.path.join(root, 'scripts', 'enrich-spots.js')
with open(out_path, 'w', encoding='utf-8') as f:
    f.write(script)
print(f"enrich-spots.js written ({len(script.splitlines())} lines)")
